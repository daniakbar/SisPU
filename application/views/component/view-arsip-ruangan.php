				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Lihat Data Lokasi Ruangan Arsip Rumah Negara Gol. III</span></h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Data Lokasi Ruangan Arsip</li>
						</ul>
				...
				<div class="content">
						...
						<div id="form" class="panel panel-flat animated">
							<div class="panel-heading">
								<h5 class="panel-title" id="title">Tambah Lokasi Ruangan Arsip</h5>
							</div>

							<div class="panel-body">
								<p class="content-group-lg">Silahkan masukkan data lokasi ruangan arsip dengan benar.</p>

								<?php echo form_open('component/viewarsipruangan', array('method' => 'POST', 'class' => 'form-horizontal'));?>
								<fieldset class="content-group">

									<?php echo validation_errors();?>

									<legend class="text-bold">Detail Lokasi Ruangan Arsip</legend>

									<input type="hidden" name="id" id="id" value="">

									<div class="form-group">
										<label class="control-label col-lg-2">Ruangan Arsip</label>
										<div class="col-lg-10">
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-credit-card"></i></span>
												<input name="ruangan" id="ruangan" type="text" class="form-control" placeholder="">
											</div>
										</div>
									</div>
								</fieldset>
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Data Lokasi Ruangan Arsip</h5>
							</div>

							<div class="panel-body">
								Lihat Semua Data Lokasi Ruangan Arsip
								...
								<tbody>
									<?php
										if(is_object($ruangan) || is_array($ruangan)) :
                                            $no = 1;
											...
											<ul class="icons-list">
												<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right">
														...
														<li><a href="#" onclick="ubah('<?=$row->ruangan?>')"><i class="icon-pencil7"></i> Ubah</a></li>
...
<script type="text/javascript">
		...
		function ubah(ruangan)
    	{
    		$('#title').text("Ubah Lokasi Ruangan Arsip");
    		$('#id').val(ruangan);
    		$('#ruangan').val(ruangan);
    	...
    	function tambah()
    	{
    		...
    		$('#title').text("Tambah Lokasi Ruangan Arsip");
    		$('#id').val("");
    		$('#ruangan').val("");
