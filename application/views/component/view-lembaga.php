				...
				<div class="content">
						...
						<div id="form" class="panel panel-flat animated">
							<div class="panel-heading">
								<h5 class="panel-title" id="title">Tambah Kelembagaan</h5>
							</div>

							<div class="panel-body">
								<p class="content-group-lg">Silahkan masukkan data kelembagaan dengan benar.</p>
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title animation"  data-animation="shake">Data Kelembagaan</h5>
							</div>

							<div class="panel-body">
								Lihat Semua Data Kelembagaan
